"""The screens the TUI is made of.
    ...
    stats     figures across a set of properties rather than about one
    analysis  one of those figures, opened over whatever is in scope
    sql       the database queried directly, for the cross-property questions
"""
